...
{ 
    ...
    { 
        ...
        ReadyQueue[0].iStart = timePoint;
        ReadyQueue[0].iResponse = timePoint - ReadyQueue[0].iArrival;
        timePoint += ReadyQueue[0].iBurst;
        ReadyQueue[0].iWaiting = timePoint - ReadyQueue[0].iArrival - ReadyQueue[0].iBurst;
        ReadyQueue[0].iTaT = timePoint - ReadyQueue[0].iArrival;
