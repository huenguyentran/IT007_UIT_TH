...
{ 
    ...
    PCB GanttChart[10];
    srand(time(NULL));
    int iNumberOfProcess = 0, quantumtime; 
    printf("Please input number of Process: "); 
    scanf("%d", &iNumberOfProcess);
    printf("Please input quantumtime: "); 
    scanf("%d", &quantumtime);
    ...
    { 
        ...
        if(ReadyQueue[0].iRemainingTime <= quantumtime)
        {
            timePoint += ReadyQueue[0].iRemainingTime;
            ReadyQueue[0].iRemainingTime = 0;
        }
        else
        {
            timePoint += quantumtime;
            ReadyQueue[0].iRemainingTime -= quantumtime;
        }
        ...
        if(temp.iRemainingTime == 0)
        {
            temp.iFinish = timePoint;
            temp.iResponse = temp.iStart - temp.iArrival;
            temp.iTaT = temp.iFinish - temp.iArrival;
            temp.iWaiting = temp.iFinish - temp.iArrival - temp.iBurst;
